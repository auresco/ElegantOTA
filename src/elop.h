...
const char ELEGANT_HTML_HOME[] PROGMEM = R"rawliteral(
<!doctype html>
<html lang='en'>
    <head>
        <meta charset='UTF-8'/>
		...
		<style>
		  .logo-container {
			...
			align-items: center;
			height: 47px; /* Ajuste a altura conforme necessário */
			text-align: center;
			margin-top: 20px; /* Ajuste o espaço superior, se necessário */ 
		  }
		</style>
    </head>
    <body>
